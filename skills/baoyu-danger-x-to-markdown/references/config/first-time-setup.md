...
| 选择 | Path | 范围 |
|--------|------|-------|
| User | `~/.baoyu-skills/baoyu-danger-x-to-markdown/EXTEND.md` | 所有 projects |
| Project | `.baoyu-skills/baoyu-danger-x-to-markdown/EXTEND.md` | 当前 project |
