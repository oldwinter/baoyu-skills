...
options:
  - label: "gpt-image-2.5-flare (Recommended)"
    description: "Latest GPT Image model，速度最快；支持最高 4K 的 flexible sizes 和 high-fidelity image inputs"
  - label: "gpt-image-2.5-sunburst"
    description: "最强 GPT Image model，适合复杂场景和精细编辑，但速度较慢"
  - label: "gpt-image-2"
    description: "Previous GPT Image generation，支持最高 4K 的 flexible sizes"
  - label: "gpt-image-1.5"
...
options:
  ...
  - label: "qwen-image-3.0-pro"
    description: "Newest Qwen flagship；same sizing rules，当前不是 built-in default"
